...
# question = "granddaughter('Zara Phillips','Queen Elizabeth II')."
# answer =Check_Question_True_False(KB, question)
# # question =  "wife('Princess Anne', X)."

# # answer = Find_Answer(KB, question)

# print('****: ',answer)

# list1 = [["Parent1 = 'PrinceAndrew'", "Uncle1 = 'PrinceCharles'"], ["Parent1 = 'SarahFerguson'", "Uncle1 = 'PriCharles'"]]
# list2 = [tuple("Uncle1 = 'PrinceCharles'"), tuple("Uncle1 = 'PrinceAndrew'"), tuple("Uncle1 = 'PrincePhillip'")]
# print(Find_General_Solutions(list1, list2))
